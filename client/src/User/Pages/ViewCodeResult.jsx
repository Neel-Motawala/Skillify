...
export default function ViewCodeResult() {
    const { id, codeTestId } = useParams(); // id = courseId
    ...
    // Derive course name from first submission's code_language
    const courseName = submissions?.[0]?.code_language?.toUpperCase() || "UNKNOWN";
            ...
            {test && (
                <div className={styles.testInfo}>
                    ...
                    <div className={styles.infoGrid}>
                        ...
                        <p>
                            <strong>Stage:</strong> {test.stage}
                        </p>
                        <p>
                            <strong>Mode:</strong> {test.test_mode}
                        </p>
                        <p>
                            <strong>Date:</strong>{" "}
